 ...
 */
final class Version20230412165220 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE modele DROP marque, DROP nom, DROP carburant, DROP boite_vitesse, DROP image, DROP prix_base, DROP cheveaux, DROP zero_cent');
    }
}
